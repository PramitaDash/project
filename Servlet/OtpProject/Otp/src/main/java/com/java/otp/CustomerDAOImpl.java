	...
	public class CustomerDAOImpl implements CustomerDAO {
		...
		public Customer searchByUserName(String userName) throws ClassNotFoundException, SQLException {
			...
			if (rs.next()) {
				...
				customer.setCustomer_Firstname(rs.getString("firstname"));
				customer.setCustomer_LastName(rs.getString("lastName"));
				customer.setCustomer_UserName(rs.getString("userName"));
				customer.setCustomer_Password(rs.getString("password"));
				customer.setCustomer_Email(rs.getString("email"));
				customer.setCustomer_PhoneNo(rs.getString("PhoneNo"));
				customer.setCustomer_Status(rs.getString("status"));
			}
			return customer;
		}
