package com.java.ejb;
	...
	public class RemoteEJBClient {
		...
		private static Context createInitialContext()  {
		   ...
		   private static CaculationRemote lookupRemoteStatelessCalculator()  {
			   Context ctx =null;
		   ...
		   //     System.out.println(RemoteCalculator.class.getName());
		        final String viewClassName = CaculationRemote.class.getName();
		        // let's do the lookup
		     ...
		     //   return (RemoteCalculator) context.lookup("ejb:" + appName + "/" + moduleName + "/" + distinctName + "/" + beanName + "!" + viewClassName);
	          ...
	          //  String distinctName = "";
	           ...
	           // String viewClassName = RemoteCalculator.class.getName();
	            try {
					return (CaculationRemote) ctx.lookup("ejb:" 
					  + appName + "/" + moduleName 
		 ...
		 private static void invokeStatelessBean()  {
		        ...
		        final CaculationRemote statelessRemoteCalculator = lookupRemoteStatelessCalculator();
